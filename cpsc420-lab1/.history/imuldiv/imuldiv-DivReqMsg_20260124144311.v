...
// this is that special bit that determines unsigned or signed division
// div vs divu
`define IMULDIV_DIVREQ_MSG_FUNC_SZ         1

// for unsigned, this bit is set to zero
...
// this defines where each field is
// first field is the func bit
`define IMULDIV_DIVREQ_MSG_FUNC_FIELD      64
// last two fields are the operand indices
...
(
  ...
  // size of func bit, operancds
  // splits it into three inputs and one 65 bit output
  ...
  // these are bit numbers / indices
  // bit 64
  assign bits[`IMULDIV_DIVREQ_MSG_FUNC_FIELD] = func;
  // bits 63:32 (a slice, like in python)
